...
class AdminMockStore extends ChangeNotifier {
  ...
  final Map<String, List<AdminRecord>> _records = {
    ...
    'bookings': [
      AdminRecord(id: 'BKG-260618-041', values: {
      ...
      AdminRecord(id: 'BKG-260618-038', values: {
      ...
      AdminRecord(id: 'BKG-260617-129', values: {
    ...
    'payments': [
      AdminRecord(id: 'MT-932891', values: {
      ...
      AdminRecord(id: 'MT-932874', values: {
      ...
      AdminRecord(id: 'MT-932810', values: {
    ...
    'invoices': [
      AdminRecord(id: 'INV-20260618-041', values: {
        'booking': 'BKG-260618-041',
        'customer': 'Budi Santoso',
        'technician': 'Andi Kurniawan',
        'total': 'Rp350.000',
      ...
      AdminRecord(id: 'INV-20260618-038', values: {
        'booking': 'BKG-260618-038',
        'customer': 'Rina Amelia',
        'technician': 'Sari Dewi',
        'total': 'Rp475.000',
  ...
  void create(String section, Map<String, String> values) {
    ...
    _sequence++;
    _records.putIfAbsent(section, () => []).insert(
          0,
          AdminRecord(id: '$prefix-$_sequence', values: values),
        );
    notifyListeners();
  }
  ...
  void setStatus(String section, String id, String status) {
    final record = _records[section]?.where((item) => item.id == id).firstOrNull;
